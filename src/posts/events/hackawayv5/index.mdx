...
# TODO: For future explorers, I think Ash's logo isn't as good as the original.
# Get rid of the following "logo" lines to disable the logo.
# Please don't use Git Blame to see who pushed this.
hackaway_logo:
  light: ./lockup.svg
  dark: ./lockup_white.svg
navigation:
  - label: Discord
