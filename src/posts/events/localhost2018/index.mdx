...
import { localhostBackground, logo } from "./2018.module.scss"

<EventJumbotron className={`${localhostBackground} text-center`}>

<Whatever src={localhostLogo} className={logo} alt="MLH LocalHost 2018 Logo" />

  <h1>LocalHost 2018</h1>
  <p>01 October 2018, 12:00:00 PM Mccrea 125</p>
  <p class="lead">
    Pick up a new skill, and build somewithing with it
  </p>
</EventJumbotron>
